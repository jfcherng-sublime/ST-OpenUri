...
def set_timeout(f: Callback0, timeout_ms: int = ...) -> None: ...
def set_timeout_async(f: Callback0, timeout_ms: int = ...) -> None: ...
...
class Window:
    ...
    def show_quick_panel(self,
                         ...
                         flags: int = ...,
                         selected_index: int = ...,
                         on_highlight: Optional[Callback1[int]] = ...
                         ) -> None: ...
...
class View:
    ...
    def size(self) -> int: ...
    def begin_edit(self, edit_token: int, cmd: str,
                   args: Optional[Dict[str, Any]] = ...) -> Edit: ...
    ...
    def find_all(self,
                 ...
                 flags: int = ...,
                 fmt: Optional[str] = ...,
                 extractions: Optional[List[str]] = ...) -> List[Vector]: ...
    def settings(self) -> 'Settings': ...
    ...
    def find_by_class(self, pt: int, forward: bool, classes: int,
                      separators: str = ...) -> Region: ...
    def expand_by_class(self, x: Union[Region, int], classes: int,
                        separators: str = ...) -> Region: ...
    ...
    def show_at_center(self, x: Union[Region, int]) -> None: ...
    def viewport_position(self) -> Vector: ...
    def set_viewport_position(
        self, xy: Vector, animate: bool = ...) -> None: ...
    ...
    def add_phantom(self, key: str, region: Region, content: str,
                    layout: int, on_navigate: Optional[Callback1[str]] = ...) -> int: ...
